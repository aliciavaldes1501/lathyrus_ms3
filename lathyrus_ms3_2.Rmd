...
ggsave(filename=
          "output/figures/AppendixS3_1A.tiff",
...
ggplot(subset(data_selag,year>2008),aes(x=FFD,y=grazing_success/(grazing_success+grazing_failure),
  ...
  facet_wrap(~year,ncol=3,scales="free")+ylab("Grazing")+xlab("FFD")
ggsave(filename=
          "output/figures/AppendixS3_1B.tiff",
...
ggsave(filename=
          "output/figures/AppendixS3_2A.tiff",
        device="tiff",width=168,height=210,units="mm",dpi=300,compression="lzw")
ggplot(subset(data_selag,year>2008),aes(x=FFD,y=n_seeds_per_fl))+my_theme()+
  ...
  facet_wrap(~year,ncol=3,scales="free")+ylab("Number of seeds per flower")+xlab("FFD")
ggsave(filename=
          "output/figures/AppendixS3_2B.tiff",
        device="tiff",width=168,height=158,units="mm",dpi=300,compression="lzw")
```
...
ggsave(filename=
          "output/figures/AppendixS3_3A.tiff",
        device="tiff",width=168,height=210,units="mm",dpi=300,compression="lzw")
ggplot(subset(data_selag,year>2008),aes(x=FFD,y=n_pred_seeds/(n_pred_seeds+n_intact_seeds),
  ...
  facet_wrap(~year,ncol=3,scales="free")+ylab("Seed predation")+xlab("FFD")
ggsave(filename=
          "output/figures/AppendixS3_3B.tiff",
        device="tiff",width=168,height=158,units="mm",dpi=300,compression="lzw")
```
